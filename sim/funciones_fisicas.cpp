...
auto func_fis::delta_densidades(int particula1, int particula2, std::vector<Particle> & old_vector,
...
double func_fis::trasnfer_accel_particulas(int particula1, int particula2,
  ...
  double acceleration_3 =
      old_vector[particula1].densidad + old_vector[particula2].densidad - dens_fluido;
...
void func_fis::collisiones_limite_eje_x(int c_x, int particula,
                                        std::vector<Particle> const & old_vector,
                                        std::vector<Particle> & new_vector) {
  ...
  if (c_x == 0) {
    ...
    if (delta_x > pow(10, -10)) {
      new_vector[particula].a.x =
          old_vector[particula].a.x + s_c * delta_x - d_v * old_vector[particula].v.x;
    }
...
void func_fis::collisiones_limite_eje_y(int c_x, int particula,
  ...
  if (c_x == 0) {
    ...
    if (delta_y > pow(10, -10)) {
      new_vector[particula].a.y =
          old_vector[particula].a.y + s_c * delta_y - d_v * old_vector[particula].v.y;
    }
...
void func_fis::collisiones_limite_eje_z(int c_z, int particula,
  ...
  if (c_z == 0) {
    ...
    if (delta_z > pow(10, -10)) {
      new_vector[particula].a.z =
          old_vector[particula].a.z + s_c * delta_z - d_v * old_vector[particula].v.z;
    }
...
void func_fis::actualizar_posicion(int particula, std::vector<Particle> const & old_vector,
                                   std::vector<Particle> & new_vector) {
  // Que narices, creo que las fórmulas estan mal en el pg, ágina 10 al final
  new_vector[particula].p.x = old_vector[particula].p.x + old_vector[particula].hv.x * delta_t +
                              old_vector[particula].a.x * delta_t * delta_t;
  new_vector[particula].p.y = old_vector[particula].p.y + old_vector[particula].hv.y * delta_t +
                              old_vector[particula].a.y * delta_t * delta_t;
  new_vector[particula].p.z = old_vector[particula].p.z + old_vector[particula].hv.z * delta_t +
                              old_vector[particula].a.z * delta_t * delta_t;
}

void func_fis::actualizar_velocidad(int particula, std::vector<Particle> const & old_vector,
                                    std::vector<Particle> & new_vector) {
  new_vector[particula].v.x =
      old_vector[particula].hv.x + (old_vector[particula].a.x * delta_t) / 2;
  new_vector[particula].v.y =
      old_vector[particula].hv.y + (old_vector[particula].a.y * delta_t) / 2;
  new_vector[particula].v.z =
      old_vector[particula].hv.z + (old_vector[particula].a.z * delta_t) / 2;
}

void func_fis::actualizar_gradiente(int particula, std::vector<Particle> const & old_vector,
                                    std::vector<Particle> & new_vector) {
...
void func_fis::actualizar_movimiento(int particula, std::vector<Particle> const & old_vector,
                                     std::vector<Particle> & new_vector) {
